...
export default function LandingPageNav() {
    ...
    return (
        <motion.nav className={cn(
            "relative",
            scrollYProgressHeight >= 1 && "backdrop-blur-sm bg-white/45 dark:bg-background/45 fixed top-0 right-0 z-20 left-0 w-full"
        )}>
            <div className="container mx-auto px-4">
                <div className="relative flex h-24 items-center">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 hidden lg:flex items-center">
                        <Link className="inline-block  hover:text-teal-400 mr-10" href="/#features">
                            Features
                        </Link>
                        <Link className="inline-block  hover:text-teal-400 mr-10" href="/#pricing">
                            Pricing
                        </Link>
                    </div>
